...
public class Get20_yt extends CrawlThread {
	...
	public void run() {
		...
		try {
			...
			for (String item : allhref_list) {
				...
				System.out.println(" 20 대 댓글 추출 수 = " + comments.size());
				// 다수의 값을 comments 에 넣기
				this.splitKeyword_class.StoreSplitedKeyWord( 20 , this.splitKeyword_class.SplitKeyWord_(comments));
			}
