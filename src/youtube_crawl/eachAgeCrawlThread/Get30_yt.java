...
public class Get30_yt extends CrawlThread {
	...
	public void run() {
		...
		try {
			// Crawl_href2 클래스 사용
			allhref_list = crawl_href.Crwal_Href(Config_win.cf.youtube_Age_30_URL, driver);
			...
			for (String item : allhref_list) {
				...
				System.out.println(" 30 대 댓글 추출 수 = " + comments.size());
				// 다수의 값을 comments 에 넣기
				this.splitKeyword_class.StoreSplitedKeyWord( 30 , this.splitKeyword_class.SplitKeyWord_(comments));
			}
