...
public class Get10SC extends CrawlThread {

	@Override
	public void run() {
		
		getTermBtnECO( Config.cf.getTermBtnECO_Time );
		
		this.copt = new ChromeOpt( Config.cf.fmkorea_Age_10_URL );
		...
		try {
			 ...
			 */
			allUrlList = cauip.CAUIP( wd , Config.cf.Age_10_Keyword );
			...
			for (String item : allUrlList) {
				...
				this.splitKWIC.StoreSplitedKWIC( Config.cf.Age_10 , this.splitKWIC.SplitKWIC( commentsList ) ) ; 
