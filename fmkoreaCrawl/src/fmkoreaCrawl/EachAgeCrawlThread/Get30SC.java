...
public class Get30SC extends CrawlThread {

	@Override
	public void run() {
		
		getTermBtnECO( Config.cf.getTermBtnECO_Time * 3 );
		
		this.copt = new ChromeOpt( Config.cf.fmkorea_Age_30_URL );
		...
		try {
			 ...
			 */
			allUrlList = cauip.CAUIP( wd , Config.cf.Age_30_Keyword );
			...
			for (String item : allUrlList) {
				...
				this.splitKWIC.StoreSplitedKWIC( Config.cf.Age_30 , this.splitKWIC.SplitKWIC( commentsList ) ) ; 
