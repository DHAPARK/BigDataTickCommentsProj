...
public class Get50SC extends CrawlThread {

	@Override
	public void run() {
		
		getTermBtnECO( Config.cf.getTermBtnECO_Time * 5 );
		
		this.copt = new ChromeOpt( Config.cf.fmkorea_Age_50_URL );
		...
		try {
			 ...
			 */
			allUrlList = cauip.CAUIP( wd , Config.cf.Age_50_Keyword );
			...
			for (String item : allUrlList) {
				...
				this.splitKWIC.StoreSplitedKWIC( Config.cf.Age_50 , this.splitKWIC.SplitKWIC( commentsList ) ) ; 
