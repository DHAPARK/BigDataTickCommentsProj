...
//				wd.findElements(By.className(Config.cf.seeMoreYoutube)).get( 0 ).click();
	...
	// 객체화 시키기 전 
	// youtube 20대 만 단일 테스트 
	
	public ArrayList<String> CAUIP20(WebDriver wd) throws InterruptedException {
		...
		// 유튜브 20대 페이지 에서 <a> 태그 조회 실패 - 이유 ???
		urlListInPage = (ArrayList<WebElement>) wd.findElements(By.className(Config.cf.Youtubehref));
		System.out.println("여기서 ? ");
		for (WebElement item : urlListInPage) {
